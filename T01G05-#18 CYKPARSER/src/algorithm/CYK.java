...
public class CYK extends Thread{
	...
	public CYK(CYKPnl parent, int sleepTimeMilli)
	{
		super("CYK");
		this.parent = parent;
		this.sleepTime = sleepTimeMilli;
		inputSize=0;
		OFFSET=1;
		isSuccessful=false;
	...
	public static Vector<String> splitString(String line) {
	...
	{
		if(toProcess!=null)
		{toProcess.clear();toProcess=null;}
		if(panels!=null)
